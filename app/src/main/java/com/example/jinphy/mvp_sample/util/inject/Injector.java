package com.example.jinphy.mvp_sample.util.inject;
...
public class Injector {
    ...
    public static void injectViews(Activity activity){
        ...
        for (Field view : views) {
            ...
            BindView annotation = view.getAnnotation(BindView.class);
    ...
    private static void injectView(Activity activity,Field field, BindView annotation) {
    ...
    * */
    private static void injectListener(Activity activity, Method method,BindClick annotation) {
        // 创建该方法对应的监听器
